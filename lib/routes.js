...
FlowRouter.route('/userProfile/:id', {
  name: 'userProfile',
  action() {
    BlazeLayout.render('appBody', { main: 'currentUserProfile' });
  },
});

FlowRouter.route('/notifications/:id', {
  name: 'notifications',
  action() {
    BlazeLayout.render('appBody', { main: 'listNotif' });
  },
});
